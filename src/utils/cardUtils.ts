...
export const CARD_ORDER = [
  // Top 4 special cards (individual)
  { value: 1, suit: 'sword' },    // #1 - Strongest
  { value: 1, suit: 'club' },     // #2
  { value: 7, suit: 'sword' },    // #3  
  { value: 7, suit: 'coin' },     // #4
  
  // All 3s (same strength group)
  { value: 3, suit: 'sword' }, { value: 3, suit: 'club' }, { value: 3, suit: 'coin' }, { value: 3, suit: 'cup' },
  
  // All 2s (same strength group)
  { value: 2, suit: 'sword' }, { value: 2, suit: 'club' }, { value: 2, suit: 'coin' }, { value: 2, suit: 'cup' },
  
  // Remaining 1s (same strength group) - coin and cup only, since sword and club are in top 4
  { value: 1, suit: 'coin' }, { value: 1, suit: 'cup' },
  
  // All 12s (same strength group)
  { value: 12, suit: 'sword' }, { value: 12, suit: 'club' }, { value: 12, suit: 'coin' }, { value: 12, suit: 'cup' },
  
  // All 11s (same strength group)
  { value: 11, suit: 'sword' }, { value: 11, suit: 'club' }, { value: 11, suit: 'coin' }, { value: 11, suit: 'cup' },
  
  // All 10s (same strength group)
  { value: 10, suit: 'sword' }, { value: 10, suit: 'club' }, { value: 10, suit: 'coin' }, { value: 10, suit: 'cup' },
  
  // Remaining 7s (same strength group) - club and cup only, since sword and coin are in top 4
  { value: 7, suit: 'club' }, { value: 7, suit: 'cup' },
  
  // All 6s (same strength group)
  { value: 6, suit: 'sword' }, { value: 6, suit: 'club' }, { value: 6, suit: 'coin' }, { value: 6, suit: 'cup' },
  
  // All 5s (same strength group)
  { value: 5, suit: 'sword' }, { value: 5, suit: 'club' }, { value: 5, suit: 'coin' }, { value: 5, suit: 'cup' },
  
  // All 4s (same strength group) - Weakest
